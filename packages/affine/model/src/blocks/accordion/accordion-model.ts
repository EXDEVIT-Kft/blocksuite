...
export const AccordionBlockSchema = defineBlockSchema({
  ...
  toModel: () => new AccordionBlockModel(),
});

export class AccordionBlockModel extends BlockModel<AccordionBlockProps> {}

export const AccordionBlockSchemaExtension = BlockSchemaExtension(
