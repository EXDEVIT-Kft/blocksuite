import * as icons2 from '@blocksuite/affine-editor-icons';
import * as icons from '@blocksuite/icons/lit';
import { html } from 'lit';

// Paragraph icons

export const TextIcon = icons2.TextFontIcon({
  width: '20',
  height: '20',
});

export const HeadingIcon = icons2.HeadingIcon({
  width: '20',
  height: '20',
});

export const Heading1Icon = icons2.Heading1Icon({
  width: '20',
  height: '20',
});

export const Heading2Icon = icons2.Heading2Icon({
  width: '20',
  height: '20',
});

export const Heading3Icon = icons2.Heading3Icon({
  width: '20',
  height: '20',
});

export const Heading4Icon = icons2.Heading4Icon({
  width: '20',
  height: '20',
});

export const Heading5Icon = icons2.Heading5Icon({
  width: '20',
  height: '20',
});

export const Heading6Icon = icons2.Heading6Icon({
  width: '20',
  height: '20',
});

export const BulletedListIcon = icons2.BulletedListIcon({
  width: '20',
  height: '20',
});

export const NumberedListIcon = icons2.NumberedListIcon({
  width: '20',
  height: '20',
});
...
export const CodeBlockIcon = icons2.CodeBlockIcon({
  width: '20',
  height: '20',
});

export const QuoteIcon = icons2.QuoteIcon({
  width: '20',
  height: '20',
});

export const DividerIcon = icons2.DividerIcon({
  width: '20',
  height: '20',
});
...
export const BoldIcon = icons2.BoldIcon({
  width: '20',
  height: '20',
});

export const ItalicIcon = icons2.ItalicIcon({
  width: '20',
  height: '20',
});

export const UnderlineIcon = icons2.UnderlineIcon({
  width: '20',
  height: '20',
});

export const StrikethroughIcon = icons2.StrikeThroughIcon({
  width: '20',
  height: '20',
});

export const CodeIcon = icons2.CodeInlineIcon({
  width: '20',
  height: '20',
});
...
// Date & Time icons
export const TodayIcon = icons2.DateTodayIcon({
  width: '20',
  height: '20',
});

export const TomorrowIcon = icons2.DateTomorrowIcon({
  width: '20',
  height: '20',
});

export const YesterdayIcon = icons2.DateYesterdayIcon({
  width: '20',
  height: '20',
});

export const NowIcon = icons2.DateTimeIcon({
  width: '20',
  height: '20',
});
 ...
 * ✅
 */
export const ConfirmIcon = icons2.DoneIcon({
  width: '20',
  height: '20',
});
...
export const HighLightDuotoneIcon = icons2.PaintIcon({
  width: '20',
  height: '20',
});
