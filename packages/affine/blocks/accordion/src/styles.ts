...
export const accordionBlockStyles = css`
  ...
  .h1-accordion.algogrind-accordion-block-head code {
    font-size: calc(var(--algogrind-text-paragraph-size, 15px) + 10px);
    padding: 0px 4px;
  }
  ...
  .h2-accordion.algogrind-accordion-block-head code {
    font-size: calc(var(--algogrind-text-paragraph-size, 15px) + 8px);
    padding: 0px 4px;
  }
  ...
  .h3-accordion.algogrind-accordion-block-head code {
    font-size: calc(var(--algogrind-text-paragraph-size, 15px) + 6px);
    padding: 0px 4px;
  }
  ...
  .h4-accordion.algogrind-accordion-block-head code {
    font-size: calc(var(--algogrind-text-paragraph-size, 15px) + 4px);
    padding: 0px 4px;
  }
  ...
  .h5-accordion.algogrind-accordion-block-head code {
    font-size: calc(var(--algogrind-text-paragraph-size, 15px) + 2px);
    padding: 0px 4px;
  }
  ...
  .h6-accordion.algogrind-accordion-block-head code {
    font-size: var(--algogrind-text-paragraph-size, 15px);
    padding: 0px 4px 2px;
  }
  ...
  .algogrind-accordion-block-head::after {
    ...
    background-image: repeating-linear-gradient(
      to right,
      var(--algogrind-border-color, var(--affine-border-color)) 0,
      var(--algogrind-border-color, var(--affine-border-color)) 5px,
      transparent 5px,
      transparent 10px
    );
  }
