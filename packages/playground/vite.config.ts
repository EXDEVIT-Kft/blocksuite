...
const chunkGroups = {
  framework: [
    require.resolve('@algogrind/block-std'),
    require.resolve('@algogrind/block-std/gfx'),
    require.resolve('@algogrind/global'),
    require.resolve('@algogrind/global/utils'),
    require.resolve('@algogrind/global/env'),
    require.resolve('@algogrind/global/exceptions'),
    require.resolve('@algogrind/global/di'),
    require.resolve('@algogrind/inline'),
    require.resolve('@algogrind/store'),
    require.resolve('@algogrind/sync'),
  ],
  components: [
    require.resolve('@algogrind/affine-components/icons'),
    require.resolve('@algogrind/affine-components/peek'),
    require.resolve('@algogrind/affine-components/portal'),
    require.resolve('@algogrind/affine-components/hover'),
    require.resolve('@algogrind/affine-components/toolbar'),
    require.resolve('@algogrind/affine-components/toast'),
    require.resolve('@algogrind/affine-components/rich-text'),
    require.resolve('@algogrind/affine-components/caption'),
    require.resolve('@algogrind/affine-components/context-menu'),
    require.resolve('@algogrind/affine-components/date-picker'),
    require.resolve('@algogrind/affine-components/drag-indicator'),
  ],
  affine: [
    require.resolve('@algogrind/affine-shared'),
    require.resolve('@algogrind/affine-model'),
    require.resolve('@algogrind/affine-block-list'),
    require.resolve('@algogrind/affine-block-paragraph'),
    require.resolve('@algogrind/affine-block-surface'),
    require.resolve('@algogrind/data-view'),
  ],
  ...
  blocks: [
    require.resolve('@algogrind/blocks'),
    require.resolve('@algogrind/blocks/schemas'),
  ],
