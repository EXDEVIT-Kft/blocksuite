...
const chunkGroups = {
  framework: [
    '@algogrind/block-std',
    '@algogrind/block-std/gfx',
    '@algogrind/global',
    '@algogrind/global/utils',
    '@algogrind/global/env',
    '@algogrind/global/exceptions',
    '@algogrind/global/di',
    '@algogrind/inline',
    '@algogrind/store',
    '@algogrind/sync',
  ...
  components: [
    '@algogrind/affine-components/icons',
    '@algogrind/affine-components/peek',
    '@algogrind/affine-components/portal',
    '@algogrind/affine-components/hover',
    '@algogrind/affine-components/toolbar',
    '@algogrind/affine-components/toast',
    '@algogrind/affine-components/rich-text',
    '@algogrind/affine-components/caption',
    '@algogrind/affine-components/context-menu',
    '@algogrind/affine-components/date-picker',
    '@algogrind/affine-components/drag-indicator',
  ],
  affine: [
    '@algogrind/affine-shared',
    '@algogrind/affine-model',
    '@algogrind/affine-block-list',
    '@algogrind/affine-block-paragraph',
    '@algogrind/affine-block-surface',
    '@algogrind/data-view',
  ],
  ...
  blocks: ['@algogrind/blocks', '@algogrind/blocks/schemas'],
  presets: ['@algogrind/presets'],
  common: [
