...
export const NOTE_OVERLAY_STOKE_COLOR = '--algogrind-border-color';
export const NOTE_OVERLAY_TEXT_COLOR = '--algogrind-text-paragraph-color';
...
export const NoteColor = 'var(--algogrind-primary-color)';
